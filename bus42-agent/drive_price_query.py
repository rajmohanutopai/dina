...
QUERY = "How much are organic bananas at Corner Market?"
...
time.sleep(1.2)
screenshot("/tmp/sim_price_typed.png")
...
screenshot("/tmp/sim_price_result.png")
print("### DONE — see /tmp/sim_price_result.png")
