 ...
 * `peerlens-flag-cli.ts` (TN-FLAG-002): lives in `appview/`, opens a
 ...
 *
 * **Usage**:
 *   npx tsx src/admin/peerlens-suspend-pds-cli.ts add <host> <reason>
 *   npx tsx src/admin/peerlens-suspend-pds-cli.ts remove <host>
 *   npx tsx src/admin/peerlens-suspend-pds-cli.ts list
 *
 ...
 *     `peerlens-enrich-cli.ts` for the not-found case).
 */
