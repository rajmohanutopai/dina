/**
 * Unit tests for `appview/src/api/middleware/peerlens-flag-gate.ts`
 * (TN-FLAG-003).
 *
 * Contract:
...
import { gatePeerlensNamespace as gateTrustNamespace } from '@/api/middleware/peerlens-flag-gate'
