...
describe('§5 Idempotency (Fix 1)', () => {
  ...
  it('IT-IDP-003: Fix 1: replay reaction → onConflictDoNothing', async () => {
    const collection = 'com.dinakernel.peerlens.reaction'
    const rkey = 'idp003'
    const uri = makeUri(collection, rkey)
    ...
    const op = {
      ...
      cid: 'cid-idp003',
      record: {
        targetUri: 'at://did:plc:someone/com.dinakernel.peerlens.attestation/target001',
        reaction: 'helpful',
        createdAt: now,
      },
    }
  ...
  it('IT-IDP-005: Fix 1: all 19 handler types — replay safe', async () => {
    ...
    const handlerConfigs = [
      ...
      },
      {
        ...
        rkey: 'idp005-rxn',
        record: {
          targetUri: 'at://did:plc:root/com.dinakernel.peerlens.attestation/root001',
          reaction: 'helpful',
          createdAt: now,
        },
      ...
      },
      {
        ...
        rkey: 'idp005-rev',
        record: {
          targetUri: 'at://did:plc:root/com.dinakernel.peerlens.attestation/nonexistent',
      ...
      },
      {
        ...
        record: {
          name: 'My Collection',
          items: ['at://did:plc:item/com.dinakernel.peerlens.attestation/item1'],
          isDiscoverable: true,
          createdAt: now,
        },
