...
describe('15.1 Label Detectors', () => {
  ...
  it('IT-LBL-001: fake-review detector -- correlated timing', async () => {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      await insertAttestation({
        uri: `at://did:plc:reviewer${i}/com.dinakernel.peerlens.attestation/lbl001-${i}`,
  ...
  it('IT-LBL-002: ai-generated detector -- undisclosed', async () => {
    ...
    for (let i = 0; i < 5; i++) {
      await insertAttestation({
        uri: `at://did:plc:aigenDid/com.dinakernel.peerlens.attestation/lbl002-${i}`,
  ...
  it('IT-LBL-003: self-promotion detector', async () => {
    ...
    await insertAttestation({
      uri: `at://${selfDid}/com.dinakernel.peerlens.attestation/lbl003`,
      did: selfDid,
      subjectName: selfDid,
      subjectDid: selfDid,
      sentiment: 'positive',
  ...
  it('IT-LBL-004: coordinated detector', async () => {
    ...
    for (let i = 0; i < coordinatedDids.length; i++) {
      await insertAttestation({
        uri: `at://${coordinatedDids[i]}/com.dinakernel.peerlens.attestation/lbl004-${i}`,
  ...
  it('IT-LBL-005: conflict-of-interest detector', async () => {
    ...
    await insertDelegation({
      uri: `at://${subjectDid}/com.dinakernel.peerlens.delegation/lbl005`,
    ...
    await insertAttestation({
      uri: `at://${authorDid}/com.dinakernel.peerlens.attestation/lbl005`,
      did: authorDid,
  ...
  it('IT-LBL-006: no labels for clean reviews', async () => {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      await insertAttestation({
        uri: `at://${diverseDids[i]}/com.dinakernel.peerlens.attestation/lbl006-${i}`,
        did: diverseDids[i],
