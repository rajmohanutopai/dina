...
describe('18 Web Server (HIGH-09)', () => {
  ...
  it('IT-WEB-002: HIGH-09: resolve route validates params via ResolveParams', () => {
    // The server uses ResolveParams.parse(queryParams) for /xrpc/com.dinakernel.peerlens.resolve
  ...
  it('IT-WEB-003: HIGH-09: search route validates params via SearchParams', () => {
    // The server uses SearchParams.parse(queryParams) for /xrpc/com.dinakernel.peerlens.search
  ...
  it('IT-WEB-005: HIGH-09: unknown XRPC method returns error shape', () => {
    ...
    const errorResponse = { error: 'InvalidRequest', message: 'Unknown method: com.dinakernel.peerlens.nonexistent' }
