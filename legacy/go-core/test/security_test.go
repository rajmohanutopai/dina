...
func TestSecurity_17_6_TLSEnforcement(t *testing.T) {
	...
	compose, err := os.ReadFile("../../../legacy/compose/docker-compose.yml")
	if err != nil {
...
func TestSecurity_17_7_DockerNetworkIsolation(t *testing.T) {
	...
	composeData, readErr := os.ReadFile(filepath.Join("..", "..", "..", "legacy/compose/docker-compose.yml"))
	if readErr != nil {
		composeData, readErr = os.ReadFile(filepath.Join("..", "legacy/compose/docker-compose.yml"))
	}
	if readErr == nil {
...
func TestSecurity_17_27_BrainNetStandard(t *testing.T) {
	...
	compose, err := os.ReadFile("../../../legacy/compose/docker-compose.yml")
	if err != nil {
		compose, err = os.ReadFile("../compose/docker-compose.yml")
	}
	if err != nil {
