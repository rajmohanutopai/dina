// dina-relay — Dina D2D encrypted mailbox.
//
// A lightweight relay that forwards NaCl-encrypted blobs between
...
import (
	...
	relay "github.com/rajmohanutopai/dina/relay/internal"
)

func main() {
	// Configuration from environment.
	addr := envOr("RELAY_LISTEN_ADDR", ":7700")
	...
	buf, err := relay.NewBuffer(dbPath)
	if err != nil {
	...
	hub := relay.NewHub(buf)
	handler := relay.NewHandler(hub)
