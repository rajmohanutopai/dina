/**
 * Mobile facade smoke test for `apps/mobile/src/peerlens/plc_namespace.ts`
...
import {
  ...
  PLCSubmitError,
  submitPlcOperation,
} from '../../src/peerlens/plc_namespace';

describe('apps/mobile/src/peerlens/plc_namespace re-exports', () => {
