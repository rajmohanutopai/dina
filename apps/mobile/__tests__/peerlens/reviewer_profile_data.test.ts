/**
 * Tests for `src/peerlens/reviewer_profile_data.ts` (TN-MOB-015).
 *
 * Pure data-layer derivation: PeerlensProfile → display-ready projection.
 * The screen layer (`app/peerlens/reviewer/[did].tsx`) renders these
