/**
 * Tests for `src/peerlens/subject_detail_data.ts` (TN-MOB-012).
 *
 * Pure data layer — input → header bundle + 3 grouped review lists.
 * The screen layer (`app/peerlens/[subjectId].tsx`) renders these
...
import { deriveSubjectCard } from '../../src/peerlens/subject_card';
import {
  MAX_ALTERNATIVES,
  deriveAlternatives,
  deriveFlagWarning,
