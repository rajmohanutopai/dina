...
jest.mock('../../src/peerlens/runners/use_network_feed', () => ({
  __esModule: true,
  useNetworkFeed: () => ({ feed: [], isLoading: false, error: null }),
}));

jest.mock('../../src/peerlens/runners/use_reviewer_profile', () => ({
  __esModule: true,
...
function makeProfile(overrides: { totalAttestationsBy?: number; handle?: string | null } = {}) {
  // Minimal shape the projection reads. `as never` because PeerlensProfile has
