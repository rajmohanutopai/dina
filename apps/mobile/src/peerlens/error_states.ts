...
export const ERROR_STATE_CONTENT: Readonly<Record<ErrorState, ErrorStateContent>> = Object.freeze({
  offline: Object.freeze({
    ...
    body: `Connect to the internet to load ${FEATURE_NAMES.peerlens} data.`,
    action: 'Try again',
  }),
  network_error: Object.freeze({
    title: "Couldn't reach the server",
    body: `Your device seems online, but we couldn't reach ${FEATURE_NAMES.peerlens}. Check again in a moment.`,
    action: 'Try again',
  }),
  rate_limited: Object.freeze({
    title: 'Too many requests',
    body: `You've hit the request limit. ${FEATURE_NAMES.peerlens} will be available again shortly.`,
  ...
  server_error: Object.freeze({
    title: `${FEATURE_NAMES.peerlens} is having trouble`,
