...
import { listPersonas, isPersonaOpen, type PersonaState } from '@dina/core';
import {
  clearVaults,
  getItem,
  queryVault,
 ...
 */
export function searchVault(persona: string, query: string, limit?: number): VaultSearchResult[] {
