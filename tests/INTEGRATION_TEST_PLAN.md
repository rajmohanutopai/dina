...
> Specialist bots register with PeerLens and expose a standard query API.
...
| P3 (Low) | Performance benchmarks, chaos engineering, PeerLens | Quality: failure affects non-functional requirements |
