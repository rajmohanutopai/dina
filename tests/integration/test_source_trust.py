...
# policy filtering is part of the M3 PeerLens gate (tasks
...
class TestProvenanceStorage:
    ...
    # TRACE: {"suite": "INT", "case": "0205", "section": "11", "sectionName": "PeerLens Integration", "subsection": "01", "scenario": "01", "title": "store_with_full_provenance"}
    ...
    # TRACE: {"suite": "INT", "case": "0206", "section": "11", "sectionName": "PeerLens Integration", "subsection": "01", "scenario": "02", "title": "store_with_contradicts"}
...
class TestRetrievalPolicyFiltering:
    ...
    # TRACE: {"suite": "INT", "case": "0207", "section": "11", "sectionName": "PeerLens Integration", "subsection": "02", "scenario": "01", "title": "default_search_excludes_quarantine_and_briefing"}
    ...
    # TRACE: {"suite": "INT", "case": "0208", "section": "11", "sectionName": "PeerLens Integration", "subsection": "02", "scenario": "02", "title": "include_all_returns_everything"}
...
class TestUserWriteDefaults:
    ...
    # TRACE: {"suite": "INT", "case": "0209", "section": "11", "sectionName": "PeerLens Integration", "subsection": "03", "scenario": "01", "title": "store_without_provenance_gets_defaults"}
