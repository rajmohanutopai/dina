...
# TST-INT-303
    ...
    def test_custom_lexicon_validation(
        ...
        """Trust records use custom com.dinakernel.peerlens.* lexicons.
        The AppView indexes only matching lexicons."""
        records = [
            {
                "id": "rec_1",
                "lexicon": "com.dinakernel.peerlens.review",
            ...
            {
                "id": "rec_2",
                "lexicon": "com.dinakernel.peerlens.outcome",
        ...
        # Only the two com.dinakernel.peerlens.* records are indexed
        assert indexed == 2
        assert len(mock_app_view.indexed_records) == 2
        lexicons = {r["lexicon"] for r in mock_app_view.indexed_records}
        assert all(lex.startswith("com.dinakernel.peerlens.") for lex in lexicons)
...
# TST-INT-308
    ...
    def test_aggregate_scores_computed_not_stored(
        ...
        assert all(
            r.get("lexicon") != "com.dinakernel.peerlens.aggregate"
...
# TST-INT-318
    ...
    def test_foundation_pds_stores_only_trust_data(
        ...
        records = [
            ...
            {
                "id": "personal_1",
                "lexicon": "com.dinakernel.personal.message",
                "author_did": "did:plc:Author1",
                "body": "Hey, how are you?",
            },
            {
                "id": "health_1",
                "lexicon": "com.dinakernel.health.record",
                "author_did": "did:plc:Author1",
        ...
        assert mock_app_view.indexed_records[0]["lexicon"] == "com.dinakernel.peerlens.review"
