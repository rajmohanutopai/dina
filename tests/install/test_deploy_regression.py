...
LEGACY_CORE_MAIN = PROJECT_ROOT / "legacy/go-core/cmd/dina-core/main.go"
LEGACY_BRAIN_MAIN = PROJECT_ROOT / "legacy/python-brain/src/main.py"
...
class TestEnvVarSeparation:
    ...
    def test_community_pds_uses_separate_vars(self) -> None:
        ...
        compose = (PROJECT_ROOT / "legacy/compose/docker-compose.yml").read_text()
    ...
    def test_install_writes_community_pds_vars(self) -> None:
        ...
        install = (PROJECT_ROOT / "legacy/bin/install.sh").read_text()
...
class TestRunShRebuild:
    ...
    def test_run_sh_uses_build_flag(self) -> None:
        ...
        run_sh = (PROJECT_ROOT / "legacy/bin/run.sh").read_text()
...
class TestPLCRegistration:
    ...
    def test_core_has_eager_did_creation(self) -> None:
        ...
        main_go = LEGACY_CORE_MAIN.read_text()
...
class TestBrainStartupResilience:
    ...
    def test_telegram_startup_has_retry(self) -> None:
        ...
        main_py = LEGACY_BRAIN_MAIN.read_text()
