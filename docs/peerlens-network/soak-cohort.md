...
> - `docs/peerlens-network/ops-runbook.md` — incident response for
>   the soak window (TN-OPS-002).
> - `docs/peerlens-network/observability.md` — what to watch (TN-OBS-001).
> - `docs/peerlens-network/threat-model.md` — what V1 doesn't promise
>   (TN-DOCS-002).
