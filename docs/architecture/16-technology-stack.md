...
| Client ↔ Node protocol | Authenticated WebSocket (TLS + Ed25519 signature or CLIENT_TOKEN auth frame) | Encrypted channel. CLI uses Ed25519 request signing exclusively. Non-CLI clients use CLIENT_TOKEN Bearer. |
