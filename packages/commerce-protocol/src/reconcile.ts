...
/**
 * A record the BUYER retained, together with the supplier's signature
 * over it (§12.7, §16.2).
 *
 ...
 * own key over the exact bytes.
 *
 * `signature` is hex-encoded Ed25519 over the record's canonical JSON.
