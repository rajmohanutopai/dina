...
// importing from `@dina/core/peerlens/pds_publish`, but the type
// definitions live in one place. See `@dina/protocol/peerlens/types`.
export type {
  Attestation,
  Confidence,
  DimensionRating,
 ...
 */
const ATTESTATION_LEXICON = PEERLENS_NSIDS.attestation;
